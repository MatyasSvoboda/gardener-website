  ...
  return (
   <section className="py-24">
        <div className="mx-auto px-5 sm:px-10 md:px-12 lg:px-5">
            <div className="bg-gradient-to-br from-green-200 to-green-300 dark:from-green-900 dark:bg-green-800 rounded-lg p-8 md:p-10 py-14 lg:p-14 items-center justify-center text-center md:text-center md:justify-center md:items-center gap-8 py-10">
